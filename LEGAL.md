...
The software does not contain, incorporate, derive from, or rely upon any
confidential information, proprietary material, customer data, trade secrets,
private repositories, internal systems, credentials, unpublished documentation,
business plans, source code, technical materials, employer-provided resources, or
non-public information belonging to any employer, former employer, client,
...
Specifically, **NetApp®**, **Active IQ®**, **ONTAP®**, **StorageGRID®**,
**SnapCenter®**, **FabricPool®**, **Astra Trident™**, **BlueXP®**, and all
other NetApp product and service names referenced in this Software are trademarks
or registered trademarks of NetApp, Inc. in the United States and/or other
countries. NetApp, Inc. is not a sponsor, contributor, owner, or licensor of
this Software. No customer names, customer-specific data, internal NetApp
pricing, internal operational procedures, or confidential business information
of any kind is embedded in, distributed with, or derivable from this Software.

---

## 3. No Proprietary Third-Party Information

The Software is built exclusively on:

- **Publicly documented APIs** (NetApp Active IQ Digital Advisor GraphQL API
  and publicly documented REST endpoints);
- **Public product documentation** (docs.netapp.com, security.netapp.com,
  NetApp Knowledge Base, NIST NVD, MITRE CVE);
- **The Author's independent knowledge and analysis** of publicly available
  information.

The Software does not contain and was not built using any:

- Internal systems, codebases, or internal tooling of any employer or client;
...
| Redistribution (source or compiled) | ⛔ Requires Author's **prior written consent** |
...
| Representing as an official NetApp product | ⛔ Prohibited |

See [LICENSE](LICENSE) for the full, binding terms.
...
may constitute an infringement of the Author's moral rights.
...
product or service, offer it as part of a managed service, or distribute it to
third parties, you must obtain a commercial license from the Author **before**
any such use commences.
...
accuracy, completeness, or fitness for purpose of any data, output, risk
assessment, upgrade recommendation, or advisory displayed by this Software.

Users are solely responsible for independently verifying all technical
recommendations before executing any change on production systems.

The Author shall not be liable for any loss, damage, outage, data corruption,
contract breach, or financial harm arising from reliance on this Software's
output.
...
- This `LEGAL.md` and the accompanying `LICENSE` file constitute the complete
  legal terms governing this Software.
- In the event of any conflict between this document and the `LICENSE` file,
  the `LICENSE` file prevails.
