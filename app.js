  ...
  if (s.snapmirror && s.snapmirror.enabled && s.snapmirror.relationships) {
    ...
    if (hasSyncRel && !risks.some(r => r.id === 501)) {
      risks.push({
        ...
        kbLink: "https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/SnapMirror/SnapMirror_Synchronous_policies",
        remediationPlan: {
  ...
  if (osVer && !isStorageGrid && !isEseries) {
    ...
    if (!hasVaronisAudit && name.includes("primary")) {
      risks.push({
        ...
        kbLink: "https://kb.netapp.com/Advice_and_Troubleshooting/Data_Security/FPolicy/Varonis_FPolicy_integration_best_practices",
        remediationPlan: {
  ...
  if (is910OrNewer && !isStorageGrid && !isEseries) {
    ...
    if (!hasFirewallRisk && name.includes("primary")) {
      risks.push({
        ...
        kbLink: "https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/ONTAP_LIF_service_policies_and_firewall_rules",
        remediationPlan: {
