...
const MOCK_SYSTEMS = [
  ...
  },
  {
    ...
    status: "warning",
    clusterRawCapacityTB: 142.8,
    clusterUsableCapacityTB: 128.5,
    clusterPhysicalUsedTB: 71.4,
    clusterLogicalUsedTB: 250.0,
    clusterMgmtIp: "10.200.50.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 2,
    localTierCount: 4,
    ...
    qtreeCount: 12,
    snapmirrorCount: 3,
    clusterQoQUtilPct: 6.8,
    clusterYoYUtilPct: 22.4,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 31.5, rawTB: 63.0 },
      { month: "2025-09", usedTB: 34.2, rawTB: 68.4 },
      { month: "2025-10", usedTB: 37.1, rawTB: 74.2 },
      { month: "2025-11", usedTB: 40.5, rawTB: 81.0 },
      { month: "2025-12", usedTB: 42.8, rawTB: 85.6 },
      { month: "2026-01", usedTB: 45.0, rawTB: 90.0 },
      { month: "2026-02", usedTB: 50.2, rawTB: 100.4 },
      { month: "2026-03", usedTB: 55.4, rawTB: 110.8 },
      { month: "2026-04", usedTB: 60.1, rawTB: 120.2 },
      { month: "2026-05", usedTB: 65.8, rawTB: 131.6 },
      { month: "2026-06", usedTB: 68.6, rawTB: 137.2 },
      { month: "2026-07", usedTB: 71.4, rawTB: 142.8 }
    ],
    risks: [
      {
        id: 201,
        ...
        recommendation: "Upgrade Astra Trident driver to v26.06 (current GA) to mitigate CVE-2026-24051 and ensure compatibility with Kubernetes v1.36 APIs.",
        ...
        remediationPlan: {
          ...
          steps: [
            ...
            "2. Download the Trident installer bundle v26.06.",
            "3. Run the installer upgrade command: 'tridentctl upgrade -n trident --to-image netapp/trident:26.06.0'.",
            "4. Verify Pod status: 'kubectl get pods -n trident' and verify all pods are running version 26.06.0."
          ],
          options: [
            "Option A (Helm Upgrade - Recommended): Use Helm package manager: 'helm upgrade trident netapp-trident/trident-operator --version 26.06.0'.",
            "Option B (Operator Upgrade): Apply the updated Trident Operator manifests manually."
          ],
          thirdParty: "Compatible with Kubernetes v1.29 through v1.36. Ensure downstream apps are prepared for dynamic PV mounts."
        }
      },
      {
        id: 202,
  ...
  },
  {
    ...
    status: "critical",
    clusterRawCapacityTB: 3400.0,
    clusterUsableCapacityTB: 2975.0,
    clusterPhysicalUsedTB: 850.0,
    clusterLogicalUsedTB: 850.0,
    clusterMgmtIp: "10.10.20.5",
    haConfigured: false,
    nodeSvmCount: 0,
    dataSvmCount: 0,
    localTierCount: 0,
    ...
    qtreeCount: 0,
    snapmirrorCount: 0,
    clusterQoQUtilPct: 12.1,
    clusterYoYUtilPct: 28.5,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 490.0, rawTB: 1960.0 },
      { month: "2025-09", usedTB: 560.0, rawTB: 2240.0 },
      { month: "2025-10", usedTB: 616.0, rawTB: 2464.0 },
      { month: "2025-11", usedTB: 651.0, rawTB: 2604.0 },
      { month: "2025-12", usedTB: 675.5, rawTB: 2702.0 },
      { month: "2026-01", usedTB: 700.0, rawTB: 2800.0 },
      { month: "2026-02", usedTB: 730.0, rawTB: 2920.0 },
      { month: "2026-03", usedTB: 760.0, rawTB: 3040.0 },
      { month: "2026-04", usedTB: 790.0, rawTB: 3160.0 },
      { month: "2026-05", usedTB: 820.0, rawTB: 3280.0 },
      { month: "2026-06", usedTB: 835.0, rawTB: 3340.0 },
      { month: "2026-07", usedTB: 850.0, rawTB: 3400.0 }
    ],
    risks: [
      {
        id: 301,
  ...
  },
  {
    ...
    status: "warning",
    clusterRawCapacityTB: 426.3,
    clusterUsableCapacityTB: 312.6,
    clusterPhysicalUsedTB: 142.1,
    clusterLogicalUsedTB: 540.0,
    clusterMgmtIp: "10.100.30.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 3,
    localTierCount: 8,
    ...
    qtreeCount: 38,
    snapmirrorCount: 12,
    clusterQoQUtilPct: 5.5,
    clusterYoYUtilPct: 18.2,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 77.0, rawTB: 231.0 },
      { month: "2025-09", usedTB: 83.5, rawTB: 250.5 },
      { month: "2025-10", usedTB: 88.3, rawTB: 264.9 },
      { month: "2025-11", usedTB: 96.2, rawTB: 288.6 },
      { month: "2025-12", usedTB: 103.1, rawTB: 309.3 },
      { month: "2026-01", usedTB: 110.0, rawTB: 330.0 },
      { month: "2026-02", usedTB: 115.4, rawTB: 346.2 },
      { month: "2026-03", usedTB: 122.1, rawTB: 366.3 },
      { month: "2026-04", usedTB: 128.5, rawTB: 385.5 },
      { month: "2026-05", usedTB: 135.0, rawTB: 405.0 },
      { month: "2026-06", usedTB: 138.5, rawTB: 415.5 },
      { month: "2026-07", usedTB: 142.1, rawTB: 426.3 }
    ],
    risks: [
      {
        id: 401,
  ...
  },
  {
    ...
    platform: "FAS9000 MetroCluster IP",
    status: "normal",
    clusterRawCapacityTB: 404.1,
    clusterUsableCapacityTB: 296.3,
    clusterPhysicalUsedTB: 134.7,
    clusterLogicalUsedTB: 512.0,
    clusterMgmtIp: "10.100.31.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 3,
    localTierCount: 8,
    ...
    clusterYoYUtilPct: 18.2,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 70.0, rawTB: 210.0 },
      { month: "2025-09", usedTB: 80.0, rawTB: 240.0 },
      { month: "2025-10", usedTB: 87.0, rawTB: 261.0 },
      { month: "2025-11", usedTB: 93.5, rawTB: 280.5 },
      { month: "2025-12", usedTB: 97.0, rawTB: 291.0 },
      { month: "2026-01", usedTB: 100.0, rawTB: 300.0 },
      { month: "2026-02", usedTB: 108.0, rawTB: 324.0 },
      { month: "2026-03", usedTB: 114.0, rawTB: 342.0 },
      { month: "2026-04", usedTB: 120.0, rawTB: 360.0 },
      { month: "2026-05", usedTB: 128.0, rawTB: 384.0 },
      { month: "2026-06", usedTB: 131.3, rawTB: 393.9 },
      { month: "2026-07", usedTB: 134.7, rawTB: 404.1 }
    ],
    risks: [
      {
        id: 411,
  ...
  },
  {
    ...
    status: "warning",
    clusterRawCapacityTB: 182.3,
    clusterUsableCapacityTB: 127.6,
    clusterPhysicalUsedTB: 72.9,
    clusterLogicalUsedTB: 350.0,
    clusterMgmtIp: "10.150.5.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 5,
    localTierCount: 8,
    ...
    qtreeCount: 24,
    snapmirrorCount: 5,
    clusterQoQUtilPct: 3.8,
    clusterYoYUtilPct: 14.2,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 42.0, rawTB: 105.0 },
      { month: "2025-09", usedTB: 45.5, rawTB: 113.8 },
      { month: "2025-10", usedTB: 49.5, rawTB: 123.8 },
      { month: "2025-11", usedTB: 53.0, rawTB: 132.5 },
      { month: "2025-12", usedTB: 57.0, rawTB: 142.5 },
      { month: "2026-01", usedTB: 60.0, rawTB: 150.0 },
      { month: "2026-02", usedTB: 62.5, rawTB: 156.2 },
      { month: "2026-03", usedTB: 65.0, rawTB: 162.5 },
      { month: "2026-04", usedTB: 67.5, rawTB: 168.8 },
      { month: "2026-05", usedTB: 70.2, rawTB: 175.5 },
      { month: "2026-06", usedTB: 71.5, rawTB: 178.8 },
      { month: "2026-07", usedTB: 72.9, rawTB: 182.3 }
    ],
    risks: [
      {
        id: 501,
  ...
  // NEW CUSTOMER: HealthCare Solutions Inc
  {
    ...
    status: "normal",
    clusterRawCapacityTB: 100.0,
    clusterUsableCapacityTB: 70.0,
    clusterPhysicalUsedTB: 40.0,
    clusterLogicalUsedTB: 160.0,
    clusterMgmtIp: "10.50.1.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 2,
    localTierCount: 4,
    ...
    qtreeCount: 18,
    snapmirrorCount: 4,
    clusterQoQUtilPct: 4.8,
    clusterYoYUtilPct: 17.5,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 10.5, rawTB: 26.2 },
      { month: "2025-09", usedTB: 11.4, rawTB: 28.5 },
      { month: "2025-10", usedTB: 12.5, rawTB: 31.2 },
      { month: "2025-11", usedTB: 13.3, rawTB: 33.3 },
      { month: "2025-12", usedTB: 14.2, rawTB: 35.5 },
      { month: "2026-01", usedTB: 15.0, rawTB: 37.5 },
      { month: "2026-02", usedTB: 17.2, rawTB: 43.0 },
      { month: "2026-03", usedTB: 19.1, rawTB: 47.8 },
      { month: "2026-04", usedTB: 21.0, rawTB: 52.5 },
      { month: "2026-05", usedTB: 23.2, rawTB: 58.0 },
      { month: "2026-06", usedTB: 24.1, rawTB: 60.2 },
      { month: "2026-07", usedTB: 25.0, rawTB: 62.5 }
    ],
    risks: [],
    upgrades: {
      targetVersion: "9.16.1P2",
  ...
  },
  {
    ...
    status: "warning",
    clusterRawCapacityTB: 1125.0,
    clusterUsableCapacityTB: 787.5,
    clusterPhysicalUsedTB: 450.0,
    clusterLogicalUsedTB: 450.0,
    clusterMgmtIp: "10.50.2.10",
    haConfigured: false,
    nodeSvmCount: 0,
    dataSvmCount: 8,
    localTierCount: 12,
    ...
    qtreeCount: 89,
    snapmirrorCount: 28,
    clusterQoQUtilPct: 7.2,
    clusterYoYUtilPct: 24.8,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 273.0, rawTB: 682.5 },
      { month: "2025-09", usedTB: 300.0, rawTB: 750.0 },
      { month: "2025-10", usedTB: 330.0, rawTB: 825.0 },
      { month: "2025-11", usedTB: 355.0, rawTB: 887.5 },
      { month: "2025-12", usedTB: 373.0, rawTB: 932.5 },
      { month: "2026-01", usedTB: 390.0, rawTB: 975.0 },
      { month: "2026-02", usedTB: 400.0, rawTB: 1000.0 },
      { month: "2026-03", usedTB: 412.0, rawTB: 1030.0 },
      { month: "2026-04", usedTB: 425.0, rawTB: 1062.5 },
      { month: "2026-05", usedTB: 438.0, rawTB: 1095.0 },
      { month: "2026-06", usedTB: 444.0, rawTB: 1110.0 },
      { month: "2026-07", usedTB: 450.0, rawTB: 1125.0 }
    ],
    risks: [
      {
        id: 701,
  ...
  },
  {
    ...
    status: "normal",
    clusterRawCapacityTB: 125.0,
    clusterUsableCapacityTB: 87.5,
    clusterPhysicalUsedTB: 50.0,
    clusterLogicalUsedTB: 140.0,
    clusterMgmtIp: "10.50.3.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 3,
    localTierCount: 5,
    ...
    qtreeCount: 31,
    snapmirrorCount: 6,
    clusterQoQUtilPct: 5.1,
    clusterYoYUtilPct: 19.2,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 26.6, rawTB: 66.5 },
      { month: "2025-09", usedTB: 29.4, rawTB: 73.5 },
      { month: "2025-10", usedTB: 31.5, rawTB: 78.8 },
      { month: "2025-11", usedTB: 34.3, rawTB: 85.8 },
      { month: "2025-12", usedTB: 36.2, rawTB: 90.5 },
      { month: "2026-01", usedTB: 38.0, rawTB: 95.0 },
      { month: "2026-02", usedTB: 40.2, rawTB: 100.5 },
      { month: "2026-03", usedTB: 42.1, rawTB: 105.3 },
      { month: "2026-04", usedTB: 45.0, rawTB: 112.5 },
      { month: "2026-05", usedTB: 48.2, rawTB: 120.5 },
      { month: "2026-06", usedTB: 49.1, rawTB: 122.8 },
      { month: "2026-07", usedTB: 50.0, rawTB: 125.0 }
    ],
    risks: [
      {
        id: 901,
  ...
  // NEW CUSTOMER: Apex Retail Group
  {
    ...
    status: "warning",
    clusterRawCapacityTB: 75.0,
    clusterUsableCapacityTB: 52.5,
    clusterPhysicalUsedTB: 30.0,
    clusterLogicalUsedTB: 54.0,
    clusterMgmtIp: "10.80.1.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 2,
    localTierCount: 4,
    ...
    qtreeCount: 15,
    snapmirrorCount: 3,
    clusterQoQUtilPct: 3.2,
    clusterYoYUtilPct: 12.1,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 14.0, rawTB: 35.0 },
      { month: "2025-09", usedTB: 15.4, rawTB: 38.5 },
      { month: "2025-10", usedTB: 16.8, rawTB: 42.0 },
      { month: "2025-11", usedTB: 18.2, rawTB: 45.5 },
      { month: "2025-12", usedTB: 19.1, rawTB: 47.8 },
      { month: "2026-01", usedTB: 20.0, rawTB: 50.0 },
      { month: "2026-02", usedTB: 22.0, rawTB: 55.0 },
      { month: "2026-03", usedTB: 24.0, rawTB: 60.0 },
      { month: "2026-04", usedTB: 26.0, rawTB: 65.0 },
      { month: "2026-05", usedTB: 28.0, rawTB: 70.0 },
      { month: "2026-06", usedTB: 29.0, rawTB: 72.5 },
      { month: "2026-07", usedTB: 30.0, rawTB: 75.0 }
    ],
    risks: [
      {
        id: 801,
  ...
  },
  {
    ...
    clusterUsableCapacityTB: 87.5,
    clusterPhysicalUsedTB: 50.0,
    clusterLogicalUsedTB: 170.0,
    clusterMgmtIp: "10.80.3.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 3,
    localTierCount: 5,
    ...
    qtreeCount: 22,
    snapmirrorCount: 5,
    clusterQoQUtilPct: 4.5,
    clusterYoYUtilPct: 16.8,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 24.5, rawTB: 61.3 },
      { month: "2025-09", usedTB: 26.8, rawTB: 67.0 },
      { month: "2025-10", usedTB: 29.5, rawTB: 73.8 },
      { month: "2025-11", usedTB: 31.8, rawTB: 79.5 },
      { month: "2025-12", usedTB: 33.4, rawTB: 83.5 },
      { month: "2026-01", usedTB: 35.0, rawTB: 87.5 },
      { month: "2026-02", usedTB: 38.2, rawTB: 95.5 },
      { month: "2026-03", usedTB: 41.0, rawTB: 102.5 },
      { month: "2026-04", usedTB: 44.0, rawTB: 110.0 },
      { month: "2026-05", usedTB: 47.0, rawTB: 117.5 },
      { month: "2026-06", usedTB: 48.5, rawTB: 121.3 },
      { month: "2026-07", usedTB: 50.0, rawTB: 125.0 }
    ],
    risks: [],
    upgrades: {
  ...
  },
  {
    ...
    status: "warning",
    clusterRawCapacityTB: 350.0,
    clusterUsableCapacityTB: 245.0,
    clusterPhysicalUsedTB: 140.0,
    clusterLogicalUsedTB: 350.0,
    clusterMgmtIp: "10.80.4.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 5,
    localTierCount: 8,
    ...
    qtreeCount: 52,
    snapmirrorCount: 14,
    clusterQoQUtilPct: 6.1,
    clusterYoYUtilPct: 21.4,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 77.0, rawTB: 192.5 },
      { month: "2025-09", usedTB: 85.0, rawTB: 212.5 },
      { month: "2025-10", usedTB: 93.0, rawTB: 232.5 },
      { month: "2025-11", usedTB: 100.0, rawTB: 250.0 },
      { month: "2025-12", usedTB: 105.5, rawTB: 263.8 },
      { month: "2026-01", usedTB: 110.0, rawTB: 275.0 },
      { month: "2026-02", usedTB: 115.0, rawTB: 287.5 },
      { month: "2026-03", usedTB: 122.0, rawTB: 305.0 },
      { month: "2026-04", usedTB: 128.0, rawTB: 320.0 },
      { month: "2026-05", usedTB: 134.0, rawTB: 335.0 },
      { month: "2026-06", usedTB: 137.0, rawTB: 342.5 },
      { month: "2026-07", usedTB: 140.0, rawTB: 350.0 }
    ],
    risks: [
      {
        id: 840,
  ...
  // NEW CUSTOMER: Federal Aero Systems
  {
    ...
    status: "normal",
    clusterRawCapacityTB: 250.0,
    clusterUsableCapacityTB: 175.0,
    clusterPhysicalUsedTB: 100.0,
    clusterLogicalUsedTB: 450.0,
    clusterMgmtIp: "10.90.1.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 4,
    localTierCount: 6,
    ...
    qtreeCount: 44,
    snapmirrorCount: 9,
    clusterQoQUtilPct: 5.8,
    clusterYoYUtilPct: 20.2,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 56.0, rawTB: 140.0 },
      { month: "2025-09", usedTB: 62.0, rawTB: 155.0 },
      { month: "2025-10", usedTB: 67.0, rawTB: 167.5 },
      { month: "2025-11", usedTB: 72.0, rawTB: 180.0 },
      { month: "2025-12", usedTB: 76.0, rawTB: 190.0 },
      { month: "2026-01", usedTB: 80.0, rawTB: 200.0 },
      { month: "2026-02", usedTB: 84.0, rawTB: 210.0 },
      { month: "2026-03", usedTB: 88.0, rawTB: 220.0 },
      { month: "2026-04", usedTB: 92.0, rawTB: 230.0 },
      { month: "2026-05", usedTB: 96.0, rawTB: 240.0 },
      { month: "2026-06", usedTB: 98.0, rawTB: 245.0 },
      { month: "2026-07", usedTB: 100.0, rawTB: 250.0 }
    ],
    risks: [],
    upgrades: {
      targetVersion: "Up to Date",
  ...
  },
  {
    ...
    status: "normal",
    clusterRawCapacityTB: 2375.0,
    clusterUsableCapacityTB: 1662.5,
    clusterPhysicalUsedTB: 950.0,
    clusterLogicalUsedTB: 950.0,
    clusterMgmtIp: "10.90.2.10",
    haConfigured: false,
    nodeSvmCount: 0,
    dataSvmCount: 12,
    localTierCount: 18,
    ...
    qtreeCount: 182,
    snapmirrorCount: 48,
    clusterQoQUtilPct: 8.4,
    clusterYoYUtilPct: 26.8,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 560.0, rawTB: 1400.0 },
      { month: "2025-09", usedTB: 630.0, rawTB: 1575.0 },
      { month: "2025-10", usedTB: 700.0, rawTB: 1750.0 },
      { month: "2025-11", usedTB: 735.0, rawTB: 1837.5 },
      { month: "2025-12", usedTB: 768.0, rawTB: 1920.0 },
      { month: "2026-01", usedTB: 800.0, rawTB: 2000.0 },
      { month: "2026-02", usedTB: 830.0, rawTB: 2075.0 },
      { month: "2026-03", usedTB: 860.0, rawTB: 2150.0 },
      { month: "2026-04", usedTB: 890.0, rawTB: 2225.0 },
      { month: "2026-05", usedTB: 920.0, rawTB: 2300.0 },
      { month: "2026-06", usedTB: 935.0, rawTB: 2337.5 },
      { month: "2026-07", usedTB: 950.0, rawTB: 2375.0 }
    ],
    risks: [],
    upgrades: {
      targetVersion: "Up to Date",
  ...
  },
  {
    ...
    status: "optimal",
    clusterRawCapacityTB: 212.5,
    clusterUsableCapacityTB: 148.8,
    clusterPhysicalUsedTB: 85.0,
    clusterLogicalUsedTB: 85.0,
    clusterMgmtIp: "10.45.1.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 3,
    localTierCount: 6,
    ...
    qtreeCount: 34,
    snapmirrorCount: 7,
    clusterQoQUtilPct: 4.9,
    clusterYoYUtilPct: 17.8,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 59.5, rawTB: 148.8 },
      { month: "2025-09", usedTB: 63.0, rawTB: 157.5 },
      { month: "2025-10", usedTB: 66.5, rawTB: 166.3 },
      { month: "2025-11", usedTB: 70.0, rawTB: 175.0 },
      { month: "2025-12", usedTB: 73.5, rawTB: 183.8 },
      { month: "2026-01", usedTB: 76.5, rawTB: 191.3 },
      { month: "2026-02", usedTB: 78.0, rawTB: 195.0 },
      { month: "2026-03", usedTB: 80.0, rawTB: 200.0 },
      { month: "2026-04", usedTB: 82.0, rawTB: 205.0 },
      { month: "2026-05", usedTB: 83.5, rawTB: 208.8 },
      { month: "2026-06", usedTB: 84.2, rawTB: 210.5 },
      { month: "2026-07", usedTB: 85.0, rawTB: 212.5 }
    ],
    risks: [],
    upgrades: {
  ...
  },
  {
    ...
    qtreeCount: 58,
    snapmirrorCount: 11,
    clusterQoQUtilPct: 5.6,
    clusterYoYUtilPct: 19.6,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 98.0, rawTB: 245.0 },
      { month: "2025-09", usedTB: 105.0, rawTB: 262.5 },
      { month: "2025-10", usedTB: 112.0, rawTB: 280.0 },
      { month: "2025-11", usedTB: 119.0, rawTB: 297.5 },
      { month: "2025-12", usedTB: 126.0, rawTB: 315.0 },
      { month: "2026-01", usedTB: 133.0, rawTB: 332.5 },
      { month: "2026-02", usedTB: 135.0, rawTB: 337.5 },
      { month: "2026-03", usedTB: 137.0, rawTB: 342.5 },
      { month: "2026-04", usedTB: 139.0, rawTB: 347.5 },
      { month: "2026-05", usedTB: 140.0, rawTB: 350.0 },
      { month: "2026-06", usedTB: 140.0, rawTB: 350.0 },
      { month: "2026-07", usedTB: 140.0, rawTB: 350.0 }
    ],
    risks: [
      {
  ...
  },
  {
    ...
    clusterUsableCapacityTB: 87.5,
    clusterPhysicalUsedTB: 50.0,
    clusterLogicalUsedTB: 210.0,
    clusterMgmtIp: "10.45.3.10",
    haConfigured: true,
    nodeSvmCount: 2,
    dataSvmCount: 2,
    localTierCount: 4,
    ...
    qtreeCount: 28,
    snapmirrorCount: 4,
    clusterQoQUtilPct: 3.9,
    clusterYoYUtilPct: 14.8,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 28.0, rawTB: 70.0 },
      { month: "2025-09", usedTB: 30.4, rawTB: 76.0 },
      { month: "2025-10", usedTB: 32.2, rawTB: 80.5 },
      { month: "2025-11", usedTB: 34.5, rawTB: 86.3 },
      { month: "2025-12", usedTB: 37.0, rawTB: 92.5 },
      { month: "2026-01", usedTB: 40.0, rawTB: 100.0 },
      { month: "2026-02", usedTB: 42.0, rawTB: 105.0 },
      { month: "2026-03", usedTB: 44.0, rawTB: 110.0 },
      { month: "2026-04", usedTB: 46.0, rawTB: 115.0 },
      { month: "2026-05", usedTB: 48.0, rawTB: 120.0 },
      { month: "2026-06", usedTB: 49.0, rawTB: 122.5 },
      { month: "2026-07", usedTB: 50.0, rawTB: 125.0 }
    ],
    risks: [
      {
  ...
  },
  {
    ...
    platform: "StorageGRID SG6160",
    status: "warning",
    clusterRawCapacityTB: 4400.0,
    clusterUsableCapacityTB: 3850.0,
    clusterPhysicalUsedTB: 1100.0,
    clusterLogicalUsedTB: 1100.0,
    clusterMgmtIp: "10.200.20.5",
    haConfigured: false,
    nodeSvmCount: 0,
    dataSvmCount: 0,
    localTierCount: 0,
    ...
    qtreeCount: 0,
    snapmirrorCount: 0,
    clusterQoQUtilPct: 9.8,
    clusterYoYUtilPct: 31.2,
    clusterMonthlyCapacity: [
      { month: "2025-08", usedTB: 630.0, rawTB: 2520.0 },
      { month: "2025-09", usedTB: 720.0, rawTB: 2880.0 },
      { month: "2025-10", usedTB: 790.0, rawTB: 3160.0 },
      { month: "2025-11", usedTB: 845.0, rawTB: 3380.0 },
      { month: "2025-12", usedTB: 873.0, rawTB: 3492.0 },
      { month: "2026-01", usedTB: 900.0, rawTB: 3600.0 },
      { month: "2026-02", usedTB: 940.0, rawTB: 3760.0 },
      { month: "2026-03", usedTB: 980.0, rawTB: 3920.0 },
      { month: "2026-04", usedTB: 1020.0, rawTB: 4080.0 },
      { month: "2026-05", usedTB: 1060.0, rawTB: 4240.0 },
      { month: "2026-06", usedTB: 1080.0, rawTB: 4320.0 },
      { month: "2026-07", usedTB: 1100.0, rawTB: 4400.0 }
    ],
    risks: [
      {
        id: 1703,
...
const REFERENCE_LIBRARY_ADVISORIES = [
  ...
  },
  {
    ...
    remediation: "Upgrade Trident to v26.06.0+ (current GA). Check 'tridentctl version' to confirm current version.",
    url: "https://security.netapp.com/advisory/"
  },
...
// MIGRATED: All advisory data now lives in security_bulletins.json
//   → Loaded at startup via loadDynamicBulletins() → GET /api/bulletins
//   → Add new entries: POST /api/bulletins  OR  edit security_bulletins.json
// Format: { id, cve[], cvss, severity, category, title, description,
//           affectedProducts[], affectedVersions{}, fixedVersions{},
//           mitigation, published, link }
// ─────────────────────────────────────────────────────────────────────────────
let NETAPP_SECURITY_BULLETIN_DB = []; // Populated at startup from security_bulletins.json
...
// If the server is unavailable, the DB stays empty and the UI shows a warning.
// ─────────────────────────────────────────────────────────────────────────────
async function loadDynamicBulletins() {
  try {
    const res = await fetch('/api/bulletins', { cache: 'no-store' });
    if (!res.ok) { throw new Error(`HTTP ${res.status}`); }
    const data = await res.json();
    const remote = Array.isArray(data.bulletins) ? data.bulletins : [];

    // Merge into in-memory DB.
    // 'added'   = entries in the file not yet in memory (happens every page load on startup).
    // 'todayNew' = entries whose _addedAt is today — genuinely new from the latest scan.
    // The UI badge only shows todayNew so it doesn't falsely alert on every startup.
    const today = new Date().toISOString().slice(0, 10);
    const idToIdx = {};
    NETAPP_SECURITY_BULLETIN_DB.forEach((b, i) => { if (b.id) idToIdx[b.id] = i; });
    let added = 0, updated = 0, todayNew = 0;
    for (const entry of remote) {
      if (!entry.id) continue;
      if (entry.id in idToIdx) {
        NETAPP_SECURITY_BULLETIN_DB[idToIdx[entry.id]] = entry;
        updated++;
      } else {
        idToIdx[entry.id] = NETAPP_SECURITY_BULLETIN_DB.length;
        NETAPP_SECURITY_BULLETIN_DB.push(entry);
        added++;
        // Only flag as 'new today' if the scan stamped it with today's date
        if (entry._addedAt === today) todayNew++;
      }
    }

    // Invalidate memoize cache so new entries are picked up immediately
    _secBulletinCache.clear();

    state.bulletinDbMeta = {
      lastUpdated:  data.lastUpdated || null,
      serverCount:  remote.length,
      totalCount:   NETAPP_SECURITY_BULLETIN_DB.length,
      added, updated, todayNew,
      source: 'server'
    };

    if (todayNew > 0) {
      console.log(`[AIQ Security] ${todayNew} new advisor${todayNew === 1 ? 'y' : 'ies'} added today — total ${NETAPP_SECURITY_BULLETIN_DB.length}`);
    } else {
      console.log(`[AIQ Security] Advisory DB loaded: ${NETAPP_SECURITY_BULLETIN_DB.length} entries (${added} merged from file, ${updated} already in memory)`);
    }
  } catch (err) {
    // Server unavailable — no fallback. DB stays empty; UI shows warning.
    state.bulletinDbMeta = {
      lastUpdated: null, serverCount: 0,
      totalCount: 0,
      added: 0, updated: 0, source: 'unavailable'
    };
...
function _updateBulletinDbIndicator() {
  const el = document.getElementById('bulletinDbStatus');
  if (!el) return;
  const m = state.bulletinDbMeta || {};
  const count = m.totalCount || NETAPP_SECURITY_BULLETIN_DB.length;
  const date  = m.lastUpdated ? ` · updated ${m.lastUpdated}` : '';
  const newBadge = m.added > 0 ? ` <span style="color:var(--status-critical);font-weight:700">+${m.added} new</span>` : '';

  let src, color;
  if (m.source === 'server') {
    src   = '✅ live database';
    color = 'var(--accent-cyan)';
  } else if (m.source === 'unavailable') {
    src   = '⚠️ server offline — no advisories loaded';
  ...
  el.innerHTML = `<span style="color:${color}">${src}</span> · ${count} advisories${date}${newBadge}`;
}

// ─────────────────────────────────────────────────────────────────────────────
// refreshSecurityAdvisoryDB()
// Wired to the "🛡️ Refresh Security Advisory DB" button in the Sync panel.
// Calls GET /api/bulletins/scan on the server, which:
//   1. Scrapes security.netapp.com for all NTAP advisory IDs
//   2. Fetches detail + NVD CVSS for any IDs not already in the DB
//   3. Atomically writes updated security_bulletins.json
// Then reloads the in-memory DB via loadDynamicBulletins() and re-renders.
// ─────────────────────────────────────────────────────────────────────────────
async function refreshSecurityAdvisoryDB() {
  const btn      = document.getElementById('securityDbRefreshBtn');
  const iconEl   = document.getElementById('securityDbRefreshIcon');
  const textEl   = document.getElementById('securityDbRefreshText');
  const statusEl = document.getElementById('bulletinDbStatus');

  // ── Enter loading state ───────────────────────────────────────────────────
  if (btn)    { btn.disabled = true; btn.style.opacity = '0.7'; btn.style.cursor = 'not-allowed'; }
  if (iconEl) { iconEl.textContent = '⏳'; }
  if (textEl) { textEl.textContent = 'Scanning advisories…'; }

  // Show live elapsed timer in the status indicator
  let elapsed = 0;
  const timer = setInterval(() => {
    elapsed++;
    if (statusEl) {
      statusEl.innerHTML = `<span style="color:var(--accent-cyan)">🔄 Scanning PSIRT + NVD…</span> · ${elapsed}s elapsed`;
    }
    if (textEl) { textEl.textContent = `Scanning… (${elapsed}s)`; }
  }, 1000);

  try {
    // ── Call the server scan endpoint ─────────────────────────────────────
    // This is a synchronous HTTP call that may take 30-90s depending on how
    // many new advisories are found. The server scrapes security.netapp.com
    // and NVD, then writes atomically to security_bulletins.json before responding.
    const res = await fetch('/api/bulletins/scan', { cache: 'no-store' });
    clearInterval(timer);
    ...
    // result = { added, updated, total, scanned, errors, newIds }

    // ── Reload in-memory DB from the now-updated file ─────────────────────
    await loadDynamicBulletins();

    // ── Show result toast ─────────────────────────────────────────────────
    const msg = result.added > 0
      ? `✅ ${result.added} new advisor${result.added === 1 ? 'y' : 'ies'} added (${result.total} total · ${result.scanned} scanned)`
      : `✅ Already up to date — ${result.total} advisories, ${result.scanned} scanned, no new entries`;

    console.log(`[AIQ Security] Scan complete: +${result.added} new, ${result.scanned} scanned, ${result.total} total`);
    showToast(msg, result.added > 0 ? 'success' : 'info');

    if (result.errors > 0) {
      console.warn(`[AIQ Security] Scan had ${result.errors} fetch error(s) — some advisories may be incomplete`);
    }

  } catch (err) {
    clearInterval(timer);
    console.error('[AIQ Security] Scan failed:', err);
    if (statusEl) {
      statusEl.innerHTML = `<span style="color:var(--status-warning,#f59e0b)">⚠️ Scan failed — ${err.message}</span>`;
    }
    showToast(`⚠️ Advisory scan failed: ${err.message}`, 'error');
  } finally {
    // ── Restore button ────────────────────────────────────────────────────
    if (btn)    { btn.disabled = false; btn.style.opacity = ''; btn.style.cursor = ''; }
    if (iconEl) { iconEl.textContent = '🛡️'; }
    if (textEl) { textEl.textContent = 'Refresh Security Advisory DB'; }
  }
}
...
const REFERENCE_LIBRARY_INTEGRATIONS = {
  ...
  kubernetes: {
    ...
    keyFeatures: [
      ...
      "v26.06: Kubernetes 1.36 support; concurrency GA for ONTAP-NAS-Economy/SAN-Economy/ANF/SolidFire backends",
      "v26.06: AFX FlexGroup driver support (ontap-nas-flexgroup on AFX platforms)",
      "v26.06: GCNV NAS+SAN AutoGrow GA; Shift Toolkit + Red Hat OpenShift MTV integration",
      "v26.06: Read-only root filesystems; Unified ONTAP balanced placement"
    ],
    caveats: [
      "Trident v26.02+ fixes CVE-2026-24051 (PATH hijacking); v26.06.0 is current GA — upgrade recommended",
...
function showToast(message, type = 'success') {
  const colors = {
    success: { bg: 'rgba(0,230,118,0.95)',   text: '#000', shadow: 'rgba(0,230,118,0.2)'   },
    info:    { bg: 'rgba(0,200,255,0.92)',   text: '#000', shadow: 'rgba(0,200,255,0.2)'   },
    error:   { bg: 'rgba(255,51,102,0.95)',  text: '#fff', shadow: 'rgba(255,51,102,0.25)' },
  };
  ...
  if (!toast) {
    ...
    toast.style.transition = "opacity 0.3s ease, background-color 0.2s ease";
    document.body.appendChild(toast);
  }
  toast.style.backgroundColor = c.bg;
  toast.style.color            = c.text;
  toast.style.boxShadow        = `0 4px 12px ${c.shadow}`;
